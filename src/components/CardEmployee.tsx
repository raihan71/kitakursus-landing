    ...
    <div
      ...
      <div className="flex justify-between flex-col w-full h-full">
        <div className="flex justify-between items-start">
          ...
          <div className="text-white text-sm bg-green-500 px-3 py-1.5 rounded font-medium">
            ACTIVE
          </div>
        </div>
        <div className="mt-4">
          <p className="text-white font-light text-base">ID CARD: KAMU123</p>
          <p
            className={`text-white font-semibold text-2xl mt-2 ${
              isAnimating ? 'typing-glitch' : ''
            }`}
            data-text={currentJobTitle}>
            {currentJobTitle}
          </p>
          <p className="text-white font-light text-sm mt-2">Dream Company</p>
        </div>
      </div>
    </div>
  );
